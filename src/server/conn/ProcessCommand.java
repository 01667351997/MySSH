...
public class ProcessCommand implements IProcessCommand{
    ...
    public boolean login() throws IOException {
        ...
        if (auth.isValid(rsaUtil.readAccounts(), acc[0], acc[1])) {
            ...
            File file = new File("server_repository/home/"+acc[0]);
            file.mkdirs();
    ...
    @Override
    public boolean ls() {
        File file = new File("server_repository"+nDirec.getRoot_directory()+nDirec.getCurrent_directory());
    ...
    public boolean rm() {
        try{
            ...
            File currentDir = new File("server_repository"+nDirec.getRoot_directory()+nDirec.getCurrent_directory());
